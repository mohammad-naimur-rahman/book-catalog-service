...
router
  ...
  .patch(
    (0, validateRequest_1.default)(
      book_validation_1.BookValidation.updateCategoryZodSchema
    ),
    (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN),
  ...
  .delete(
    (0, validateRequest_1.default)(
      book_validation_1.BookValidation.deleteBookZodSchema
    ),
    (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN),
...
router.get(
  '/:categoryId/category',
  book_controller_1.BookController.getBookByCategory
);
