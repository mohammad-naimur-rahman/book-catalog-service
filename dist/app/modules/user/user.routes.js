...
router.get(
  ...
  (0, validateRequest_1.default)(
    user_validation_1.UserValidation.getAllUsersZodSchema
  ),
...
router
  ...
  .get(
    (0, validateRequest_1.default)(
      user_validation_1.UserValidation.getOrDeleteUserZodSchema
    ),
    (0, auth_1.default)(
      user_1.ENUM_USER_ROLE.ADMIN,
      user_1.ENUM_USER_ROLE.CUSTOMER
...
router.patch(
  ...
  (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN),
  user_controller_1.UserController.makeAdmin
);
