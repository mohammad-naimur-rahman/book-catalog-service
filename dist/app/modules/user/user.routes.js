...
router
    .route('/:id')
    .get((0, validateRequest_1.default)(user_validation_1.UserValidation.getOrDeleteUserZodSchema), (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN, user_1.ENUM_USER_ROLE.CUSTOER), user_controller_1.UserController.getUserById)
